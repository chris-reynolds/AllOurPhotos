//
//  Model classes for All Our Photos generated by dartBO.txt on 03-Dec-2019 10:02:31 by chris
//
import 'dart:async';
...
Map<String,dynamic> toMap() {
  ...
  List<dynamic> toRow({bool insert=false}) {
	...
	result.add(dbDate(firstDate?.toUtc()));
	result.add(dbDate(lastDate?.toUtc()));
	result.add(_userId);
  return result;
}  // to Row
 @override 
...
Map<String,dynamic> toMap() {
  ...
  List<dynamic> toRow({bool insert=false}) {
	...
	if (insert)
		result = super.toRow();
	result.add(dbDate(startDate?.toUtc()));
	result.add(dbDate(endDate?.toUtc()));
	result.add(source);
	result.add(_userId);
  return result;
}  // to Row
...
Map<String,dynamic> toMap() {
  ...
  List<dynamic> toRow({bool insert=false}) {
	...
	result.add(dbDate(takenDate?.toUtc()));
	result.add(dbDate(originalTakenDate?.toUtc()));
	result.add(dbDate(modifiedDate?.toUtc()));
	...
	result.add(dbDate(importedDate?.toUtc()));
