//
//  Model classes for All Our Photos generated by dartBO.txt on 24-May-2019 15:30:05 by chris
//
import 'dart:async';
...
var snapProvider = DOProvider<AopSnap>("aopsnaps",["file_name","directory","taken_date","original_taken_date","modified_date","device_name","caption","ranking","longitude","latitude","width","height","location","rotation","import_source","media_type","imported_date","media_length","tag_list","session_id","user_id",],AopSnap.maker);
...
static Future<List<AopAlbum>>all() async {
  ...
  void validate() async {
	  ...
	  if (name.length<10)
	    lastErrors.add('name must be 10 characters long');
